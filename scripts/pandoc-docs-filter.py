    ...
    for i, block in enumerate(blocks):
        ...
        if block_type in ['BulletList', 'OrderedList']:
            ...
            if i > 0:
                ...
                if isinstance(prev_block, dict) and prev_block.get('t') == 'DefinitionList':
            ...
            if block_type == 'BulletList':
                ...
                for item in list_items:
                    ...
                    if item and isinstance(item, list):
                        ...
                        for item_block in item:
                            ...
                            elif isinstance(item_block, dict) and item_block.get('t') != 'Para':
                                cleaned_item.append(item_block)
                ...
                new_blocks.append({'t': 'OrderedList', 'c': [list_attrs, new_list_items]})
            else:
                new_blocks.append(block)
        ...
        # Handle DefinitionList that might be list titles
            ...
            if i + 1 < len(blocks):
                ...
                if isinstance(next_block, dict) and next_block.get('t') in ['BulletList', 'OrderedList']:
